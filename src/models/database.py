...
class User(Base):
    ...
    # 关系
    experiment_records = relationship('ExperimentRecord', back_populates='user', cascade='all, delete-orphan')
...
class License(Base):
    ...
    # 许可证信息
    license_type = Column(String(50), default='trial')  # trial, standard, premium, enterprise
