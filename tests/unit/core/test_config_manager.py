...
@pytest.fixture()
def isolated_config_manager(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> cm.ConfigManager:
...
def test_reset_to_default_restores_sections(isolated_config_manager: cm.ConfigManager) -> None:
